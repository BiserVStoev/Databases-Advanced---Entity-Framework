namespace _02.CreateUser.Attributes
{
    ...
    class PasswordAttribute : ValidationAttribute
    {
        ...
        public PasswordAttribute(int passwordMinLen, int passwordMaxLen)
        {
        ...
        public override bool IsValid(object value)
        {
            ...
            if (passAsString.Length < this.passMinLen | passAsString.Length > this.passMaxLen | this.passMinLen > this.passMaxLen)
            {
                return false;
            }
